...
# Did processing time worsen during covid period?
...
medicaid_chip |> 
  ...
  mutate(
  processing_time = recode(processing_time,
    pct_less_than_24_hours = "< 24 Hours",
    pct_between_24_hours_and_7_days = "1–7 Days",
    pct_between_8_days_and_30_days = "8–30 Days",
    pct_between_31_days_and_45_days = "31–45 Days",
    pct_over_45days = "> 45 Days"
    ),
  ordered =TRUE
  ) |> 
  mutate(time_phase = factor(time_phase, levels = c("Pre Covid", "Covid period", "Post Covid"), ordered = TRUE)) |> #this tells which period come first
